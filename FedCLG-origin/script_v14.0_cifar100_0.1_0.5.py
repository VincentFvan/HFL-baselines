...
# # 定义要测试的mut_acc_rate值
# mut_acc_rate_values = [0.3, 0.4, 0.5]
# # mut_acc_rate_values = [0.1, 0.2]
...
#     # 保存第20轮结果
#     if len(results_test_acc["FedDU_Mut"]) >= 20:
#         radius_results["FedDU_Mut_r20_acc"].append(results_test_acc["FedDU_Mut"][19])
#         radius_results["FedDU_Mut_r20_loss"].append(results_train_loss["FedDU_Mut"][19])
#     else:
#         radius_results["FedDU_Mut_r20_acc"].append(results_test_acc["FedDU_Mut"][-1])
#         radius_results["FedDU_Mut_r20_loss"].append(results_train_loss["FedDU_Mut"][-1])
    
#     # 保存最终轮结果
#     radius_results["FedDU_Mut_final_acc"].append(results_test_acc["FedDU_Mut"][-1])
#     radius_results["FedDU_Mut_final_loss"].append(results_train_loss["FedDU_Mut"][-1])
...
# # 绘制第20轮精度对比图
# plt.figure(figsize=(14, 8))
# plt.plot(radius_df["radius"], radius_df["FedDU_Mut_r20_acc"], "s-", label="FedDU_Mut")
# plt.xlabel("radius Value", fontsize=14)
# plt.ylabel("Round 20 Test Accuracy (%)", fontsize=14)
# plt.title(f"Effect of radius on Round 20 Accuracy ({origin_model})", fontsize=16)
# plt.legend(fontsize=12)
...
# # 绘制最终精度对比图
# plt.figure(figsize=(14, 8))
# plt.plot(radius_df["radius"], radius_df["FedDU_Mut_final_acc"], "s-", label="FedDU_Mut")
# plt.xlabel("radius Value", fontsize=14)
# plt.ylabel("Final Test Accuracy (%)", fontsize=14)
# plt.title(f"Effect of radius on Final Accuracy ({origin_model})", fontsize=16)
# plt.legend(fontsize=12)
