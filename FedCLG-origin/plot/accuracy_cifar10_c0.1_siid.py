...
# 你的 JSON 文件名
json_file = "/home/fuyufan/HybridFL-baseline/FedCLG-origin/output/multi_run_v2.0_20250519_192005/srvIID/run01_results_test_acc.json"
...
plt.tight_layout()
plt.savefig("./fig/accuracy_cifar10_c0.1_siid.pdf", format='pdf', bbox_inches='tight')  # 保存为高分辨率图片
plt.show()