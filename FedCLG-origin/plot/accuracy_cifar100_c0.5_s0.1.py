...
# 你的 JSON 文件名
json_file = "/home/fuyufan/HybridFL-baseline/FedCLG-origin/output/multi_run_v2.0_20250519_154904/srvDir0p1/run01_results_test_acc.json"
...
plt.legend(fontsize=18, loc="center right", ncol=2, columnspacing=0.3, labelspacing=0.2)
plt.grid(True, linestyle='--', alpha=0.6)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.tight_layout()
plt.savefig("./fig/accuracy_cifar100_c0.5_s0.1.pdf", format='pdf', bbox_inches='tight')  # 保存为高分辨率图片
plt.show()