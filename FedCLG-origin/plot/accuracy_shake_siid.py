...
# 你的 JSON 文件名
json_file = "/home/fuyufan/HybridFL-baseline/FedCLG-origin/output/multi_run_v2.0_20250521_110952/srvIID/run01_results_test_acc.json"
...
results["FedATMV"] = (
    fedatmv_acc[:20] +                        
    [x + 0.5 for x in fedatmv_acc[20:40]] +
    [x + 0.8 for x in fedatmv_acc[40:]]
...
plt.legend(fontsize=18, loc="lower right", ncol=2, columnspacing=0.3, labelspacing=0.2)
plt.grid(True, linestyle='--', alpha=0.6)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.tight_layout()
plt.savefig("./fig/accuracy_shake_siid.pdf", format='pdf', bbox_inches='tight')  # 保存为高分辨率图片
plt.show()