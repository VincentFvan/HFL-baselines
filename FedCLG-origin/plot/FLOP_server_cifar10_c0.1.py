...
# 文件名和beta值的对应关系
beta_files = [
    ('0.1', 'all_flops_data_cifar10_resnet_20250605_190136.json'),
    ('0.5', 'all_flops_data_cifar10_resnet_20250605_190425.json'),
    ('1.0', 'all_flops_data_cifar10_resnet_20250605_190533.json'),
    ('iid', 'all_flops_data_cifar10_resnet_20250605_190629.json')
]
...
plt.ylabel('Server FLOPs ($\\times 10^{12}$)', fontsize=22)
# plt.legend(fontsize=16, ncol=2, columnspacing=0.8, labelspacing=0.3, loc="center right", bbox_to_anchor=(1, 0.44))
plt.legend(fontsize=18, ncol=2, columnspacing=0.8)
...
save_path = os.path.join(save_dir, 'min_final_acc_gflops_server_vs_beta.pdf')
