...
# 你的 JSON 文件名
json_file = "/home/fuyufan/HybridFL-baseline/FedCLG-origin/output/multi_run_20250515_113603/run_01/results_test_acc.json"
...
plt.tight_layout()
plt.savefig("./fig/accuracy_cifar100_c0.5_s0.5.pdf", format='pdf', bbox_inches='tight')  # 保存为高分辨率图片
plt.show()