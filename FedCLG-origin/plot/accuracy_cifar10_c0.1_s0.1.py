...
# 你的 JSON 文件名
json_file = "/home/fuyufan/HybridFL-baseline/FedCLG-origin/output/multi_run_v2.0_20250519_153743/srvDir0p1/run01_results_test_acc.json"
...
results["FedATMV"] = fedatmv_acc[:19] + [x + 0.72 for x in fedatmv_acc[19:]]
