...
def args_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.01,
        help="The hypter parameter for the FedProx",
    )
    parser.add_argument(
        "--ensemble_alpha",
        type=float,
        default=0.2,
        help="The hypter parameter for the FedGKD",
    )
    parser.add_argument(
        "--temperature",
        type=float,
    ...
    parser.add_argument(
        ...
        type=str,
        default="L1",
        help="Cluster Sampling: cosine or L1 or L2",
    )
    parser.add_argument("--p", type=float, default=2.0, help="power for AT")
    parser.add_argument(
        "--trans_beta", type=int, default=500, help="beta of FedAttTrans"
    )
